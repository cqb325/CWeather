            ...
            return (
                    [<View style={styles.row} key="1">
                        <View style={styles.cell}>
                            <Image source={require('../images/icons/sun.png')} style={styles.icon}/>
                            <View>
                        ...
                        <View style={styles.cell}>
                            <Image source={require('../images/icons/plane.png')} style={styles.icon}/>
                            <View>
                    ...
                    <View style={styles.row} key="2">
                        <View style={styles.cell}>
                            <Image source={require('../images/icons/cloth.png')} style={styles.icon}/>
                            <View>
                    ...
                    <View style={styles.row} key="3">
                        <View style={styles.cell}>
                            <Image source={require('../images/icons/ball.png')} style={styles.icon}/>
                            <View>
                        ...
                        <View style={styles.cell}>
                            <Image source={require('../images/icons/pill.png')} style={styles.icon}/>
                            <View>
